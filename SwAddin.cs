...
namespace Add_in_Teste_C_Sharp
{
    ...
    /// </summary>
    [Guid("102d966e-1083-4c1a-93ed-ce2984d7c61a"), ComVisible(true)]
    [SwAddin(
        Description = "Task pane com facilidade de projeto",
        Title = "Utilidades Zero Grau",
        LoadAtStartup = true
        )]
